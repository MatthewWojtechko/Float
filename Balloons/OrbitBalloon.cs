...
public class OrbitBalloon : MonoBehaviour
{
    ...
    public float actualSmooth = 0.5f;
    ...
    void LateUpdate()
    {
            ...
            cam.rotation = Quaternion.Slerp(cam.rotation, aimRotation, actualSmooth);
            ...
            cam.position = Vector3.Lerp(cam.position, player.position + camYRotation * smoothPivotOffset + aimRotation * smoothCamOffset, actualSmooth);
    }
